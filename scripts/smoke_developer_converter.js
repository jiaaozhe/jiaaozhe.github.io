...
async function testRealCurlBundle() {
    ...
    assert.match(converted.code, /os\.environ\['AUTHORIZATION'\]/);
...
async function main() {
    ...
    testRuntimeSurface();
    console.log('Validated config round-trips, loss guards, real cURL conversion, vendored WASM, and offline runtime surface.');
}
